    ...
    <div className="flex items-center gap-3">
      ...
      {!collapsed && (
        <div className="flex flex-col">
          <span className="text-sm font-semibold tracking-wider text-graphite-100">SMOP</span>
          <span className="text-[9px] font-medium tracking-widest text-graphite-400 uppercase">Mining Ops</span>
        </div>
      )}
    </div>
  );
